...
const AdminPatchActicity = ( { language } ) => {
    ...
    const { error, loading, filteredData } = UseTranslator( 'Activities' );
    ...
    return (
        <>
            ...
            { loading && loadingPatch && errorActivity && <div>Loading</div> }
                                ...
                                <Row>
                                    <Col lg={ { span: 12 } } className="pe-5 mb-5">
                                        ...
                                        >
                                            ...
                                            {
                                                filteredData.filter( opt => opt.fields.hasOwnProperty( 'Description' ) ).map( option => (
                                ...
                                <Row>
                                    <Col lg={ { span: 4, offset: 4 } }>
                                        <button
                                            type="submit"
                                            className='btn_post'
                                            disabled={ !updatedId || !updatedDescription || !updatedName || !updatedPosition || !language.value || !updatedFacts }
